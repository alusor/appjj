package com.alusorstroke.jjvm.soundcloud.player.media;
...
import com.alusorstroke.jjvm.soundcloud.player.remote.RemoteControlClientCompat;
import com.alusorstroke.jjvm.soundcloud.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "com.alusorstroke.jjvm.soundcloud.library.media.TOGGLE_PLAYBACK";
     ...
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "com.alusorstroke.jjvm.soundcloud.library.media.PREVIOUS_TRACK";
