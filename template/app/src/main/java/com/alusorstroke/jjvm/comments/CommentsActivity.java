package com.alusorstroke.jjvm.comments;
...
public class CommentsActivity extends AppCompatActivity {
	...
	private void fetchComments(final String parseableString) {
		if (type == INSTAGRAM) {
			//TODO Check if the following can stil be used for speed optimization
			//try {
			...
			//				.getString("username");
			//		comment.profileUrl = commentJson.getJSONObject("from")
