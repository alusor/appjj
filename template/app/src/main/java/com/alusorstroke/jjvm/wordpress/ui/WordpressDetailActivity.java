package com.alusorstroke.jjvm.wordpress.ui;
...
import com.alusorstroke.jjvm.comments.CommentsActivity;
import com.alusorstroke.jjvm.fav.FavDbAdapter;
import com.alusorstroke.jjvm.util.DetailActivity;
import com.alusorstroke.jjvm.util.ExpandedListView;
import com.alusorstroke.jjvm.util.Helper;
import com.alusorstroke.jjvm.util.MediaActivity;
import com.alusorstroke.jjvm.util.TrackingScrollView;
import com.alusorstroke.jjvm.util.WebHelper;
import com.alusorstroke.jjvm.web.WebviewActivity;
import com.alusorstroke.jjvm.wordpress.api.BackgroundPostCompleter;
import com.alusorstroke.jjvm.wordpress.PostItem;
import com.alusorstroke.jjvm.wordpress.api.WordpressGetTask;
import com.alusorstroke.jjvm.wordpress.api.WordpressGetTaskInfo;
...
public class WordpressDetailActivity extends DetailActivity implements BackgroundPostCompleter.BackgroundPostCompleterListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (null != post && null != bundle) {
            ...
            if (post.isCompleted()) {
                ...
                new BackgroundPostCompleter(post, getIntent().getStringExtra(EXTRA_API_BASE), this).start();
            }
    ...
    private void loadCompletedPost(final PostItem result) {
        if (null != result) {
            ...
            if ((result.getCommentCount() != 0 && result.getCommentsArray() != null || disqusParseable != null)) {
                ...
                btnComment.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        ...
                        if (disqusParseable != null) {
                            ...
                            commentIntent.putExtra(CommentsActivity.DATA_TYPE, CommentsActivity.WORDPRESS);
                        }
    ...
    public void setHTML(String source) {
        ...
        if (REMOVE_FIRST_IMG) {
            try {
                doc.select("img").first().remove(); // first image is most times
                // repeat of header
            } catch (Exception e) {
